	...
	new _vue2.default({
	  ...
	  created: function created() {
	    ...
	    this.$http.get('/getUrl').then(function (res) {
	      ...
	      _this.channel = res.body;
	      _this.ws = new WebSocket('ws://' + window.location.host + '/ws/' + _this.channel);
	      // var sessionId = null;

	      console.log('websocket address is:', _this.ws);
	      ...
	      // };
	      console.log('document contents:', _this.tesisdoc);
	      // Whenever we receive a message, update textarea
	      _this.ws.onmessage = function (e) {
	        if (e.data != _this.tesisdoc) {
	          _this.tesisdoc = e.data;
	        }
	      };
	    });
	  },
